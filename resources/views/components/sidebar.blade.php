...
<nav class="sidebar-nav flex flex-col gap-3" data-sidebar>
 ...
 <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="{{ $currentRoute === 'saas.analytics' ? '2' : '1.5' }}" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
 </svg>
 </span>
 <span class="tracking-tight sidebar-text">إحصائيات الزوار</span>
 </a>

 <a href="{{ route('saas.analytics') }}" data-tooltip="متابعة الزوار" class="{{ $linkBase }} {{ $currentRoute === 'saas.analytics.visitor' ? $activeClass : $inactiveClass }}">
 <span class="{{ $iconClass }} {{ $currentRoute === 'saas.analytics.visitor' ? '!bg-gradient-to-br !from-primary-500 !to-primary-600 !text-white !shadow-lg !shadow-primary-500/30' : 'text-slate-600 group-hover:text-primary-600 group-hover:scale-110' }}">
 <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="{{ $currentRoute === 'saas.analytics.visitor' ? '2' : '1.5' }}" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
 </svg>
 </span>
