...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
 <div>
 <h1 class="text-3xl font-bold text-gray-900">إضافة مهارة تأسيسية</h1>
 <p class="text-sm text-gray-600 mt-1">إضافة مهارة جديدة لتتبع تقدم الطلاب</p>
 </div>
...
<x-card>
 <x-card-body>
 <form method="POST" action="{{ route('admin.foundation-skills.store') }}" class="space-y-6">
 @csrf
